...
public class ShortestPath {
     ...
     */
    public static ArrayList<com.example.vamsij.travelingsalesman.Point> shortestPath(com.example.vamsij.travelingsalesman.Point[] points) {
        ...
        for (ArrayList<Integer> p : indices) {
            ...
            for (int i = 0; i < p.size()-1; i++) {
                com.example.vamsij.travelingsalesman.Point p1 = points[p.get(i)];
                com.example.vamsij.travelingsalesman.Point p2 = points[p.get(i+1)];
            ...
            com.example.vamsij.travelingsalesman.Point p1 = points[p.get(p.size()-1)];
            com.example.vamsij.travelingsalesman.Point p2 = points[p.get(0)];
        ...
        ArrayList<com.example.vamsij.travelingsalesman.Point> shortestPath = new ArrayList<com.example.vamsij.travelingsalesman.Point>();
    ...
    public static double dist(com.example.vamsij.travelingsalesman.Point p1, com.example.vamsij.travelingsalesman.Point p2) {
        double dx = p1.getX() - p2.getX();
        double dy = p1.getY() - p2.getY();
        double dist = Math.sqrt(dx*dx + dy*dy);
        return dist;
